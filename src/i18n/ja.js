const ja = {
  ...
  experience: {
    ...
    heading1: '学歴と',
    heading2: '職歴',
    note: 'CSE理工学士号取得。バングラデシュでジュニアデザイナー（HTML/CSS/JS）として1年の実務経験。日本語ビジネスレベル。現在もフロントエンド開発を継続しています。',
    ongoing: '進行中',
    nextLabel: '今後の目標',
    nexts: [
      {
  ...
  contact: {
    ...
    quote:
      '「CSE理工学士号、ジュニアデザイナーとして1年の実務経験、3言語対応（ベンガル語・英語・日本語）。日本でITエンジニアとして成長し、貢献したいと考えています。」',
    links: [
      [
        'メール',
